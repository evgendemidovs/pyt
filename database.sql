...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$20000$7ZnVKYJ7LY1M$Qmh5yeixOnpT454nDJyQSU8VlYgkmoB99OlK9o612cs=','2016-12-11 12:36:52',1,'jeka','','','jeka@ukr.net',1,1,'2016-09-28 18:17:52');
...
INSERT INTO `blog_category` VALUES (1,'obuv','obuv'),(3,'koselki','koselki');
...
INSERT INTO `blog_item` VALUES (1,'bo1',111,'http://i2.rozetka.ua/goods/1521749/apple_iphone_5s_16gb_space_gray_cpo_images_1521749958.jpg','ss',1,'http://i2.rozetka.ua/goods/1521749/apple_iphone_5s_16gb_space_gray_cpo_images_1521749958.jpg','http://i2.rozetka.ua/goods/1521749/apple_iphone_5s_16gb_space_gray_cpo_images_1521749958.jpg','http://i2.rozetka.ua/goods/1521749/apple_iphone_5s_16gb_space_gray_cpo_images_1521749958.jpg'),(2,'odoad',350,'http://i2.rozetka.ua/goods/1479571/samsung_sm_j320hzkdsek_images_1479571656.jpg','afafa',1,'http://i2.rozetka.ua/goods/1479571/samsung_sm_j320hzkdsek_images_1479571656.jpg','http://i2.rozetka.ua/goods/1479571/samsung_sm_j320hzkdsek_images_1479571656.jpg','http://i2.rozetka.ua/goods/1479571/samsung_sm_j320hzkdsek_images_1479571656.jpg'),(3,'afwr',400,'http://127.0.0.1/1.jpg','adafg',1,'http://127.0.0.1/3.jpg','http://127.0.0.1/2.jpg','http://127.0.0.1/4.jpg');
...
INSERT INTO `blog_user` VALUES (1,'faf','fafa@fafa','2016-12-11 14:10:59',0,'1'),(2,'fafa','fafa@fafa','2016-12-11 14:10:59',0,'1'),(3,'fafa','fafa@fafa','2016-12-11 14:21:00',0,''),(4,'faf','fafa@fafa','2016-12-11 14:58:01',0,''),(5,'faggggggg','fafa@fafa','2016-12-11 15:14:37',0,'');
/*!40000 ALTER TABLE `blog_user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blog_zakaz`
--

DROP TABLE IF EXISTS `blog_zakaz`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blog_zakaz` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `zakaz` varchar(255) NOT NULL,
  `summa` int(11) NOT NULL,
...
--
-- Dumping data for table `blog_zakaz`
--

LOCK TABLES `blog_zakaz` WRITE;
/*!40000 ALTER TABLE `blog_zakaz` DISABLE KEYS */;
/*!40000 ALTER TABLE `blog_zakaz` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(7,'blog','article'),(8,'blog','category'),(9,'blog','item'),(11,'blog','user'),(10,'blog','zakaz'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
-- Dump completed on 2016-12-11 17:36:08
